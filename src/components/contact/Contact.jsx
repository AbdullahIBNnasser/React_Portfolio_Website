      ...
      <div className='container contact-container'>
        <div className="contact__options">
          <article className="contact__option">
            ...
            <a href="mailto:mohd200207@gamil.com" target='_blank'>Send a message</a>
          </article>
          <article className="contact__option">
            <BsMessenger className='contact__option-icons'/>
            <h4>Messenger</h4>
            <h5>abdullah</h5>
            <a href="https://m.me/abdullah._.nasser/"target='_blank'>Send a message</a>
          </article>
          <article className="contact__option">
            <BsWhatsapp className='contact__option-icons'/>
            <h4>Whatsapp</h4>
            <h5>+123456789</h5>
            <a href="https://web.whatsapp.com/send?phone=+919080675311"target='_blank'>Send a message</a>
          </article>
          </div>
